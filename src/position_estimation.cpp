...
public:
    cloudHandler()
    {
        ...
        pcl_pub = nh.advertise<nav_msgs::Odometry>("/vo", 10);
    }
    ...
    void cloudCB(const sensor_msgs::PointCloud2 &input)
    {
        ...
        msg.child_frame_id =  "position_robot_frame";
       ...
       tf::Vector3 point(x, y, z);
        ...
        try{    
            //listener.waitForTransform("odom_combined", "kinect2_ir_optical_frame" , ros::Time::now(), ros::Duration(1));
            listener.lookupTransform( "world_frame","kinect2_ir_optical_frame",  
